...
function OrdersToFactoriesForm(props) {
  ...
  const handleSubmitOrder = async () => {
    ...
    const uploadOrder = await axios.post(
      `http://${secrets.LOCALHOST_IP}:${secrets.TOMCAT_PORT}/sales-system/sellers?newOrder=true`,
      order
    );
...
export default OrdersToFactoriesForm;
